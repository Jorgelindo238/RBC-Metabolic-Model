"""Dedicated Vercel entrypoint for RoBoCop research APIs."""
...
inner_app = FastAPI(title="airbc Research API")
...
inner_app.include_router(robocop.router)


@inner_app.get("/")
def read_root():
    return {"message": "airbc Research API is running"}


app = FastAPI(title="airbc Research API Wrapper")
